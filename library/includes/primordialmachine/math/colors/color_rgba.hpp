...
#define STRUCT_CONDITION()                                                     \
  is_floating_point_v<COMPONENT>&&                                             \
    is_same_v<COMPONENT_ARITHMETIC, component_arithmetic_saturated>&&          \
      is_color_space_v<COLOR_SPACE>&& is_same_v<COLOR_SPACE, color_space_rgba>
...
public:
  ...
  constexpr const component_type& a() const noexcept { return m_data[3]; }
  constexpr component_type& a() noexcept { return m_data[3]; }
  ...
  static this_type& plus_assignment(this_type& a, const this_type& b)
  {
    ...
    a.m_data[3] = f(a.m_data[3], b.m_data[3]);
    return a;
  }
  ...
  static this_type binary_star(const this_type& a, const component_type& b)
  {
    ...
    return this_type{
      f(a.m_data[0], b), f(a.m_data[1], b), f(a.m_data[2], b), f(a.m_data[3], b)
    };
  }
