...
struct has_minus_assignment_functor : public false_type
{}; // struct has_minus_assignment_functor

template<typename A, typename B>
constexpr bool has_minus_assignment_functor_v =
  has_minus_assignment_functor<minus_assignment_functor<A, B>>::value;

template<typename A, typename B>
struct has_minus_assignment_functor<
  minus_assignment_functor<A, B>,
  decltype(typeid(minus_assignment_functor<A, B>), void())> : public true_type
{}; // struct has_minus_assignment_functor
