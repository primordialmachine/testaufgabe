...
class negative_overflow_error;
class negative_overflow_exception;

class negative_overflow_error : public error
{
public:
...
}; // struct negative_overflow_error

class negative_overflow_exception : public exception
{
public:
  using parent_type = exception;
  negative_overflow_exception(const negative_overflow_error& error);
}; // class negative_overflow_exception
